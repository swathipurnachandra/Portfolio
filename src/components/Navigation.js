            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-3 sm:gap-4 md:gap-6">
                        <Link href="/" className="relative text-gray-300 hover:text-pink-500 transition-all group text-sm sm:text-base">
                            <span className="relative z-10">Home</span>
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-pink-500 group-hover:w-full transition-all duration-300"></span>
                        </Link>
                        <Link href="/about" className="relative text-gray-300 hover:text-pink-500 transition-all group text-sm sm:text-base">
                            <span className="relative z-10">About</span>
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-pink-500 group-hover:w-full transition-all duration-300"></span>
                        </Link>
                        <Link href="/projects" className="relative text-gray-300 hover:text-pink-500 transition-all group text-sm sm:text-base">
                            <span className="relative z-10">Projects</span>
                            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-pink-500 group-hover:w-full transition-all duration-300"></span>
                        </Link>
                        <Link href="/skills" className="relative text-gray-300 hover:text-pink-500 transition-all group text-sm sm:text-base">
